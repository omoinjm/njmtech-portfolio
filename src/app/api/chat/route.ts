...
- When the user asks about RESUME, CV, or curriculum vitae → include a CTA to /resume (external: true)
...
const FALLBACK_KNOWLEDGE: Array<{
  ...
  {
    patterns: ["who is nhlanhla", "who are you", "about nhlanhla", "about you", "tell me about", "bio", "background", "introduce"],
    response: "Nhlanhla Junior Malaza is a Johannesburg-based software developer, DevOps engineer, and AI integrations specialist. This portfolio highlights his full-stack work, technical skills, services, and ways to get in touch for freelance or full-time opportunities.",
    cta: { href: "/#home", label: "Go to home section" },
  },
  {
    patterns: ["services", "what do you offer", "what can you do", "expertise", "help with", "build for me", "offerings"],
    response: "Nhlanhla offers web development, mobile development, cloud solutions, AI integrations, backend engineering, and DevOps with CI/CD. The site's services section gives a quick overview of how he helps bring products to life with modern tooling.",
    cta: { href: "/#services", label: "View services" },
  },
  {
    patterns: ["skills", "tech stack", "technologies", "tools", "frameworks", "languages", "stack", "what do you use"],
    response: "His stack includes React, Next.js, Angular, TypeScript, C#/.NET, Python, PostgreSQL, MongoDB, Azure, Docker, Kubernetes, GraphQL, REST APIs, Git, and CI/CD. The skills section also highlights frontend, backend, database, and DevOps strengths.",
    cta: { href: "/#skills", label: "View skills" },
  },
  {
    patterns: ["projects", "portfolio", "work examples", "featured work", "case studies", "show me projects"],
    response: "The projects page is the best place to explore featured work. It groups real portfolio pieces by category so visitors can quickly browse recent builds and live examples.",
    cta: { href: "/projects", label: "Open projects" },
  },
  {
    patterns: ["contact", "reach", "email", "phone", "message", "hire", "book", "talk", "speak", "work together"],
    response: "You can contact Nhlanhla through the contact page or directly via email at njmalaza@outlook.com and phone at +27 (72) 432-6766. He typically responds within 24 hours.",
    cta: { href: "/contact", label: "Open contact page" },
  },
  {
    patterns: ["resume", "cv", "curriculum vitae", "download resume", "view resume"],
    response: "Yes — the resume is available directly from the site. You can find it from the hero section or the navigation menu.",
    cta: { href: "/resume", label: "Open resume", external: true },
  },
  {
    patterns: ["newsletter", "subscribe", "updates", "join newsletter", "email updates"],
    response: "The newsletter signup is on the home page. You can subscribe there to receive web development updates, tech insights, and exclusive content.",
    cta: { href: "/#newsletter", label: "Go to newsletter" },
  },
  {
    patterns: ["github", "linkedin", "twitter", "socials", "social links", "profiles", "links hub"],
    response: "The portfolio links out to Nhlanhla's social profiles and broader presence through the site navigation, contact page, and links hub at https://bio.njmtech.co.za/",
    cta: { href: "https://bio.njmtech.co.za/", label: "Open links hub", external: true },
  },
  {
    patterns: ["hi", "hello", "hey", "greetings"],
    response: "Hi there! I can help with questions about Nhlanhla, his portfolio, services, skills, projects, resume, contact details, and site navigation. What would you like to know?",
  },
  {
    patterns: ["thank", "thanks"],
    response: "You're welcome! If you have any other questions about Nhlanhla's background, services, projects, resume, or contact options, feel free to ask.",
  },
];
...
const getFallbackReply = (prompt: string): { content: string; cta?: { href: string; label: string; external?: boolean } } => {
  const normalizedPrompt = normalizePrompt(prompt);

  if (!normalizedPrompt) {
    return { content: "Ask me about Nhlanhla, his services, projects, skills, resume, contact details, or site navigation." };
  }
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // If no API key or Gemini fails, use fallback
    if (!apiKey) {
