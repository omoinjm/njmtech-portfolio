...
export async function seed() {
   ...
   console.log(`Created "nav_menu" table`)
   ...
   console.log(`Created "nav_footer" table`)
   ...
   console.log(`Seeded ${footer.length} footer items`)
   ...
   console.log(`Created "mail_template" table`)
   ...
   console.log(`Seeded ${template.length} mail template items`)
